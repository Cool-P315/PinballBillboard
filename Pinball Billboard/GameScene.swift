...
class GameScene: SKScene {
    ...
    private func createSpinnyNode(at pos: CGPoint, with color: SKColor) {
    ...
    func touchDown(atPoint pos: CGPoint) {
        createSpinnyNode(at: pos, with: .green)
    }
    
    func touchMoved(toPoint pos: CGPoint) {
        createSpinnyNode(at: pos, with: .blue)
    }
    
    func touchUp(atPoint pos: CGPoint) {
        createSpinnyNode(at: pos, with: .red)
    }
